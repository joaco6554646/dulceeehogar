...
const Footer = () => {
    return (
        <footer className="bg-gray-900 text-white mt-12 py-10 shadow-inner">
            ...
            {/* 🟢 CORRECCIÓN CLAVE: Eliminar 'container'. Usamos w-full en móvil, centrado en escritorio. */}
            <div className="w-full max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex space-x-4 pt-2">
                        ...
                        {/* ⚠️ Ícono de TikTok (Usando Home como sustituto) */}
            ...
            {/* Derechos de Autor */}
            {/* 🟢 CORRECCIÓN CLAVE: Aplicar la misma lógica aquí. */}
            <div className="w-full max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-gray-800 text-center">
